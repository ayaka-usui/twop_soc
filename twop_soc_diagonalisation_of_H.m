...
%% Noninteracting part independent of Omega (See the appendix)
for ss = 0:N0
    % matB
...
%% Interaction matF (See the appendix)
% fuv = f(u+1,v+1)
f00 = 1/sqrt(2*pi);
indmax = N0;
...
%% Change g12 (You do not need to change g12 for example to make Fig. 1. This is for Fig. 3(c))
g12array = (0:0.25:10);
for jg = 1:length(g12array)

    g12 = g12array(jg);
    
    % matHint (See the appendix)
    % off-diagonal terms
